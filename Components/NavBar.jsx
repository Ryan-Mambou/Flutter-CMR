...
function NavBar({navLinks, toggleMobileNav}) {
  return (
    <div className='flex flex-row justify-between items-center py-3 md:px-10 px-4 text-lg border-b-[0.05rem] fixed  z-20 bg-white w-full animate-fadeDown'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 lg:hidden cursor-pointer">
