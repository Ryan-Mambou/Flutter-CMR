  ...
  return (
    <div className='px-10 flex gap-30'>
        ...
        <div className='flex flex-col py-[14rem] gap-4'>
            <h1 className='font-bold text-6xl transition-all duration-150 ease-in'>A community open to everyone</h1>
            <p className='text-xl text-gray-600 transition-all duration-150 ease-in'>Flutter Cameroon is an initiative to focus the efforts of many developers in and around Cameroon to learn, share and become productive using Flutter.</p>
            <div className='flex transition-all duration-150 ease-in'>
            ...
            <div className='md:flex md:items-center md:gap-2 z-10 hidden shrink-0'>
                ...
                <Image src={bottomImage} className="full-rounded-image transition-all duration-150 ease-in"/>
                </div>
                <Image src={rightImage} className="full-rounded-image transition-all duration-150 ease-in"/>
            </div>
    </div>
  )
}
