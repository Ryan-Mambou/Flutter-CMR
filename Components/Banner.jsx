    ...
    <div className='md:px-10 px-4 flex flex-row gap-30'>
        ...
        <div className='flex flex-col py-[14rem] gap-4'>
            ...
            <div className='lg:flex lg:items-center lg:gap-2 z-10 hidden shrink-0'>
                <Image src={leftImage} className="full-rounded-image animate-fadeLeft" />
                <div className='flex flex-col w-36 gap-2'>
                <Image src={topImage} className="full-rounded-image w-36 animate-fadeDown"/>
                <Image src={bottomImage} className="full-rounded-image animate-fadeUp"/>
                </div>
                <Image src={rightImage} className="full-rounded-image animate-fadeRight"/>
            </div>
    </div>
  )
}
